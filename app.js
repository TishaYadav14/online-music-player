const music = new Audio(`audio/1.mp3`);      /* music.src = 'audio/1.mp3';  music.play();  in browser console*/
// music.play();
...
const songs = [
    ...
    {
        id: "10",
        songName: `Duniya <br> <div class="subtitle">Akhil, Dhvani Bhanushali</div>`,
        poster: "img/10.jpg"
    },
    {
        id: "11",
